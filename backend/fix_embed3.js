...
// Fix 1: authenticateEmbedToken function got merged with router.get('/:campaignId/stats')
const badSectionStart = embed.indexOf('  const payload = verifyEmbedToken(token);');
const badSectionEnd = embed.indexOf('/**\n * GET /api/embed/campaigns/:campaignId\n * Public endpoint gated by embed token');
